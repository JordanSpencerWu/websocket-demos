...
import { PLAYER_JOIN_GAME_EVENT, PLAYER_LEAVE_GAME_EVENT } from 'components/DemoOnePage/contants/channelEvents';
...
function WaitingState(props: Props) {
  ...
  return (
    <div className="flex flex-col text-center">
      ...
      <button className="mt-8 border border-green-gecko rounded" onClick={debounce(handleButtonClick, 200)}>{buttonText}</button>
    </div>
  )
}
