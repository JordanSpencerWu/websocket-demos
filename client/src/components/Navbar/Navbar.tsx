  ...
  return (
    <div className="fixed w-full flex flex-col justify-center items-center">
      ...
      <nav className="text-xl underline">
        <NavLink to={pathTo.home} className="border-r-2 pr-1 border-green-gecko">
          Home
        </NavLink>
        <NavLink to={pathTo.demo1.index} className="ml-1 border-r-2 pr-1 border-green-gecko">
          Phoenix Channel Demo
        </NavLink>
        <NavLink to={pathTo.demo2.index} className="ml-1">
